...
public class LoginForm {
    ...
    public static class Component {
        ...
        public void setAddAccountMultiFormAction(
                boolean isAddAccountMultiFormAction) {
        ...
        @Override
        public String toString() {
            return "Component [name=" + name + ", displayName=" + displayName
                    + ", valueIdentifier=" + valueIdentifier + ", valueMask="
                    + valueMask + ", fieldInfoType=" + fieldInfoType
                    + ", helpText=" + helpText + ", size=" + size
                    + ", maxlength=" + maxlength + ", isEditable=" + isEditable
                    + ", isOptional=" + isOptional + ", isEscaped=" + isEscaped
                    + ", isOptionalMFA=" + isOptionalMFA + ", isMFA=" + isMFA
                    ...
                    + isDirectTransferSupported + ", fieldType=" + fieldType
                    + "]";
        }
